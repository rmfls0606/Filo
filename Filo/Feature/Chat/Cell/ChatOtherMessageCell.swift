...
private extension ChatOtherMessageCell {
    ...
    func updateBubbleMinWidth() {
        ...
        let leading = CGFloat(20 + 36 + 8)
        let maxAllowed = max(0, containerWidth - leading - 60)
    ...
    func rebuildAttachments() {
        ...
        for (index, url) in files.enumerated() {
            ...
            view.bind(urlString: url, alignThumbnailOnLeft: true)
